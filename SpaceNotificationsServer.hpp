...
typedef vector<NotificationType, ShmemAllocator> MainVector;    
        managed_shared_memory segment(create_only,"spacenotifications",65536);
        const ShmemAllocator alloc_inst (segment.get_segment_manager());

     MainVector *notification_holder = segment.construct<MainVector>("spaceshared")(alloc_inst);        
                ...
                int readNotificationCounter = 0;
                        ...
                        std::ofstream outputFile("SpaceNotificationLog.txt");
